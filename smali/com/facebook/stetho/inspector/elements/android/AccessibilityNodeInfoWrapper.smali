...
.method public static createNodeInfoFromView(Landroid/view/View;)Lv/k/s/b0/b;
    .locals 1
    ...
    .line 2
    invoke-static {p0, v0}, Lv/k/s/p;->a(Landroid/view/View;Lv/k/s/b0/b;)V
...
.method public static getActions(Landroid/view/View;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lcom/facebook/stetho/inspector/elements/android/AccessibilityNodeInfoWrapper;->createNodeInfoFromView(Landroid/view/View;)Lv/k/s/b0/b;
    ...
    .line 6
    :cond_0
    invoke-virtual {v2}, Lv/k/s/b0/b$a;->a()I
    ...
    .line 7
    invoke-virtual {v2}, Lv/k/s/b0/b$a;->b()Ljava/lang/CharSequence;
...
.method public static getDescription(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    .line 7
    :cond_1
    iget-object p0, v0, Lv/k/s/b0/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 14
    invoke-static {v5, v6}, Lv/k/s/p;->a(Landroid/view/View;Lv/k/s/b0/b;)V

    .line 15
    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(Lv/k/s/b0/b;Landroid/view/View;)Z
    ...
    .line 16
    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(Lv/k/s/b0/b;Landroid/view/View;)Z
    ...
    .line 22
    :cond_6
    iget-object v5, v6, Lv/k/s/b0/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public static getFocusableReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    .line 2
    :try_start_0
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasText(Lv/k/s/b0/b;)Z

    move-result v1

    .line 3
    invoke-virtual {v0}, Lv/k/s/b0/b;->j()Z

    move-result v2

    .line 4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasNonActionableSpeakingDescendants(Lv/k/s/b0/b;Landroid/view/View;)Z

    move-result v3

    .line 5
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isActionableForAccessibility(Lv/k/s/b0/b;)Z
    ...
    :cond_3
    :try_start_4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isTopLevelScrollItem(Lv/k/s/b0/b;Landroid/view/View;)Z
...
.method public static getIgnored(Landroid/view/View;)Z
    ...
    .line 8
    :try_start_0
    invoke-virtual {v0}, Lv/k/s/b0/b;->r()Z
    ...
    :cond_3
    :try_start_1
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(Lv/k/s/b0/b;Landroid/view/View;)Z
    ...
    :cond_4
    :try_start_2
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(Lv/k/s/b0/b;Landroid/view/View;)Z
    ...
    :cond_6
    :try_start_3
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasFocusableAncestor(Lv/k/s/b0/b;Landroid/view/View;)Z
...
.method public static getIsAccessibilityFocused(Landroid/view/View;)Z
    ...
    .line 2
    invoke-virtual {p0}, Lv/k/s/b0/b;->i()Z
