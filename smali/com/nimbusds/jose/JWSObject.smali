...
.method private ensureJWSSignerSupport(Lf/s/a/f;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 1
    invoke-interface {p1}, Lf/s/a/e;->a()Ljava/util/Set;
...
.method public declared-synchronized sign(Lf/s/a/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/nimbusds/jose/JOSEException;
    ...
    .line 2
    invoke-direct {p0, p1}, Lcom/nimbusds/jose/JWSObject;->ensureJWSSignerSupport(Lf/s/a/f;)V
    :try_end_0
    ...
    invoke-interface {p1, v0, v1}, Lf/s/a/f;->a(Lcom/nimbusds/jose/JWSHeader;[B)Lcom/nimbusds/jose/util/Base64URL;
...
.method public declared-synchronized verify(Lf/s/a/g;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/nimbusds/jose/JOSEException;
    ...
    check-cast p1, Lf/s/a/i/c;

    :try_start_2
    invoke-virtual {p1, v0, v1, v2}, Lf/s/a/i/c;->a(Lcom/nimbusds/jose/JWSHeader;[BLcom/nimbusds/jose/util/Base64URL;)Z
