...
.method public snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lf0/t;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lf0/t;[J)V
    :try_end_0
...
.method public writeLengths(Lf0/d;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-interface {p1, v5}, Lf0/d;->writeByte(I)Lf0/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lf0/d;->e(J)Lf0/d;
