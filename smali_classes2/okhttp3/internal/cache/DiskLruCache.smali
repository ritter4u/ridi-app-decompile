...
.field public journalWriter:Lf0/d;
...
.method private newJournalWriter()Lf0/d;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lf0/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lf0/s;)V

    .line 3
    invoke-static {v1}, Lf0/k;->a(Lf0/s;)Lf0/d;
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lf0/t;
    ...
    :try_start_0
    invoke-virtual {v2}, Lf0/p;->m()Ljava/lang/String;
    ...
    .line 16
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lf0/d;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lf0/d;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lf0/d;
...
.method public declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 25
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lf0/d;

    const-string v1, "CLEAN"

    invoke-interface {p1, v1}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;

    move-result-object p1

    invoke-interface {p1, v3}, Lf0/d;->writeByte(I)Lf0/d;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lf0/d;)V

    .line 28
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lf0/d;

    invoke-interface {p1, v2}, Lf0/d;->writeByte(I)Lf0/d;
    ...
    invoke-interface {p1, p2}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;
    ...
    invoke-interface {p1}, Lf0/d;->flush()V
...
.method public declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 11
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lf0/d;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Lf0/d;->writeByte(I)Lf0/d;

    move-result-object p2

    invoke-interface {p2, p1}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;
    ...
    invoke-interface {p2}, Lf0/d;->flush()V
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lf0/d;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lf0/d;->writeByte(I)Lf0/d;

    move-result-object v1

    invoke-interface {v1, p1}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Lf0/d;->writeByte(I)Lf0/d;
...
.method public declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lf0/s;

    move-result-object v0

    invoke-static {v0}, Lf0/k;->a(Lf0/s;)Lf0/d;
    ...
    :try_start_2
    invoke-virtual {v3, v2}, Lf0/o;->a(Ljava/lang/String;)Lf0/d;

    move-result-object v2

    const/16 v4, 0xa

    invoke-interface {v2, v4}, Lf0/d;->writeByte(I)Lf0/d;
    ...
    invoke-virtual {v3, v5, v6}, Lf0/o;->e(J)Lf0/d;

    invoke-interface {v3, v4}, Lf0/d;->writeByte(I)Lf0/d;
    ...
    .line 8
    invoke-virtual {v3, v4}, Lf0/o;->writeByte(I)Lf0/d;
    ...
    .line 10
    iget-object v6, v5, Lokhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 11
    invoke-virtual {v3, v6}, Lf0/o;->a(Ljava/lang/String;)Lf0/d;

    move-result-object v6

    invoke-interface {v6, v7}, Lf0/d;->writeByte(I)Lf0/d;

    .line 12
    iget-object v5, v5, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-virtual {v3, v5}, Lf0/o;->a(Ljava/lang/String;)Lf0/d;
    ...
    .line 15
    iget-object v6, v5, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-virtual {v3, v6}, Lf0/o;->a(Ljava/lang/String;)Lf0/d;

    .line 16
    invoke-virtual {v5, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lf0/d;)V
...
.method public removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;

    move-result-object v0

    const/16 v2, 0x20

    invoke-interface {v0, v2}, Lf0/d;->writeByte(I)Lf0/d;
