...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lf0/e;Lf0/d;)V
    .locals 2
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lf0/e;

    .line 7
    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lf0/d;
...
.method public static synthetic access$200(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lf0/d;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lf0/d;

    return-object p0
.end method

.method public static synthetic access$300(Lokhttp3/internal/http1/Http1ExchangeCodec;Lf0/h;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lf0/h;)V
...
.method public static synthetic access$500(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lf0/e;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lf0/e;
...
.method private detachTimeout(Lf0/h;)V
    .locals 2

    .line 1
    iget-object v0, p1, Lf0/h;->a:Lf0/u;

    .line 2
    sget-object v1, Lf0/u;->NONE:Lf0/u;

    if-eqz v1, :cond_0

    .line 3
    iput-object v1, p1, Lf0/h;->a:Lf0/u;
...
.method private newChunkedSink()Lf0/s;
    .locals 3
...
.method private newChunkedSource(Lokhttp3/HttpUrl;)Lf0/t;
    .locals 2
...
.method private newFixedLengthSource(J)Lf0/t;
    .locals 2
...
.method private newKnownLengthSink()Lf0/s;
    .locals 3
...
.method private newUnknownLengthSource()Lf0/t;
    .locals 3
...
.method private readHeaderLine()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lf0/e;

    iget-wide v1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->headerLimit:J

    invoke-interface {v0, v1, v2}, Lf0/e;->a(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lf0/s;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 4
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lf0/s;
    ...
    .line 5
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lf0/s;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lf0/d;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lf0/t;
    .locals 4
    ...
    .line 2
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lf0/t;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lf0/t;
    ...
    .line 7
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lf0/t;
...
.method public skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lf0/t;ILjava/util/concurrent/TimeUnit;)Z

    .line 4
    invoke-interface {p1}, Lf0/t;->close()V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;
    ...
    .line 4
    iget-object v2, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lf0/d;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;
    ...
    .line 7
    invoke-interface {v2, v0}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;
    ...
    .line 8
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lf0/d;

    invoke-interface {p1, v0}, Lf0/d;->a(Ljava/lang/String;)Lf0/d;
