...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 12
    iput-object p2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;
    ...
    invoke-direct {p2, p1}, Lf0/o;-><init>(Lf0/s;)V

    .line 15
    iput-object p2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 31
    invoke-static {v1}, Lf0/k;->b(Ljava/net/Socket;)Lf0/t;
    ...
    invoke-direct {v0, p1}, Lf0/p;-><init>(Lf0/t;)V

    .line 33
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;
    ...
    .line 36
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lf0/e;Lf0/d;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    invoke-interface {v1}, Lf0/t;->timeout()Lf0/u;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lf0/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lf0/u;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;

    invoke-interface {v1}, Lf0/s;->timeout()Lf0/u;
    ...
    .line 17
    :cond_3
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    invoke-interface {p1}, Lf0/e;->getBuffer()Lf0/c;

    move-result-object p1

    invoke-virtual {p1}, Lf0/c;->q()Z

    move-result p1

    if-eqz p1, :cond_4

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;

    invoke-interface {p1}, Lf0/d;->b()Lf0/c;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lf0/e;Lf0/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {v3, v0, v4}, Lf/d/a/a/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    invoke-interface {v2}, Lf0/e;->q()Z
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lf0/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lf0/u;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lf0/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lf0/u;
    ...
    invoke-direct {p2, p1, p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lf0/e;Lf0/d;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v5, p0, Lokhttp3/internal/connection/RealConnection;->source:Lf0/e;

    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lf0/d;
    ...
    invoke-direct/range {v2 .. v7}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLf0/e;Lf0/d;Lokhttp3/internal/connection/Exchange;)V
