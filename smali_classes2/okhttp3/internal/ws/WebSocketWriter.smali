...
.field public final buffer:Lf0/c;
...
.field public final sinkBuffer:Lf0/c;

.field public writerClosed:Z


# direct methods
.method public constructor <init>(ZLf0/d;Ljava/util/Random;)V
    .locals 1
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:Lf0/c;
    ...
    .line 5
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lf0/d;

    .line 6
    invoke-interface {p2}, Lf0/d;->b()Lf0/c;

    move-result-object p2

    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sinkBuffer:Lf0/c;
    ...
    :cond_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lf0/c$c;
...
.method private writeControlFrame(ILokio/ByteString;)V
    ...
    .line 3
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sinkBuffer:Lf0/c;

    invoke-virtual {v1, p1}, Lf0/c;->writeByte(I)Lf0/c;
    ...
    .line 7
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sinkBuffer:Lf0/c;

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskKey:[B

    invoke-virtual {p1, v1}, Lf0/c;->write([B)Lf0/c;
    ...
    .line 10
    invoke-virtual {p1, p2}, Lf0/c;->b(Lokio/ByteString;)Lf0/c;

    .line 11
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sinkBuffer:Lf0/c;

    iget-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lf0/c$c;

    invoke-virtual {p1, p2}, Lf0/c;->a(Lf0/c$c;)Lf0/c$c;

    .line 12
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lf0/c$c;

    invoke-virtual {p1, v0, v1}, Lf0/c$c;->b(J)I
    ...
    invoke-static {p1, p2}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lf0/c$c;[B)V

    .line 14
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lf0/c$c;

    invoke-virtual {p1}, Lf0/c$c;->close()V
    ...
    invoke-virtual {p1, v0}, Lf0/c;->writeByte(I)Lf0/c;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lf0/d;
...
# virtual methods
.method public newMessageSink(IJ)Lf0/s;
    .locals 2
...
.method public writeClose(ILokio/ByteString;)V
    ...
    .line 5
    invoke-virtual {v0, p2}, Lf0/c;->b(Lokio/ByteString;)Lf0/c;
...
.method public writeMessageFrame(IJZZ)V
    ...
    .line 2
    :cond_1
    iget-object p4, p0, Lokhttp3/internal/ws/WebSocketWriter;->sinkBuffer:Lf0/c;

    invoke-virtual {p4, p1}, Lf0/c;->writeByte(I)Lf0/c;
    ...
    invoke-virtual {p1, p4}, Lf0/c;->writeShort(I)Lf0/c;
    ...
    invoke-virtual {p1, p2, p3}, Lf0/c;->j(J)Lf0/c;
    ...
    invoke-virtual {p1, p4}, Lf0/c;->write([B)Lf0/c;
    ...
    .line 13
    iget-wide p4, p1, Lf0/c;->b:J

    .line 14
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:Lf0/c;
    ...
    invoke-virtual {p1, p4, p5}, Lf0/c$c;->b(J)I
    ...
    iget-object p4, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:Lf0/c;

    invoke-virtual {p1, p4, p2, p3}, Lf0/c;->write(Lf0/c;J)V
    ...
    invoke-interface {p1}, Lf0/d;->j()Lf0/d;
