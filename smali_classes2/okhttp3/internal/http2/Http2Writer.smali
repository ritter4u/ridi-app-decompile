...
.field public final hpackBuffer:Lf0/c;
...
.method public constructor <init>(Lf0/d;Z)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lf0/d;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lf0/c;

    .line 5
    new-instance p2, Lokhttp3/internal/http2/Hpack$Writer;

    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lf0/c;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lf0/d;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lf0/c;

    invoke-interface {v0, v1, v4, v5}, Lf0/s;->write(Lf0/c;J)V
...
.method public static writeMedium(Lf0/d;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p0, v0}, Lf0/d;->writeByte(I)Lf0/d;
    ...
    .line 3
    invoke-interface {p0, p1}, Lf0/d;->writeByte(I)Lf0/d;
...
.method public declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lf0/d;
...
.method public declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lf0/d;->write([B)Lf0/d;
...
.method public declared-synchronized data(ZILf0/c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLf0/c;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public dataFrame(IBLf0/c;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lf0/s;->write(Lf0/c;J)V
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Lf0/d;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lf0/d;
    ...
    invoke-interface {p2, p1}, Lf0/d;->writeInt(I)Lf0/d;
...
.method public declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lf0/d;->writeInt(I)Lf0/d;
    ...
    invoke-interface {p1, p2}, Lf0/d;->writeInt(I)Lf0/d;
    ...
    invoke-interface {p1, p3}, Lf0/d;->write([B)Lf0/d;
...
.method public declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lf0/c;
    ...
    invoke-interface {p1, p3, v2, v3}, Lf0/s;->write(Lf0/c;J)V
...
.method public declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lf0/d;->writeInt(I)Lf0/d;
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 7
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lf0/d;

    const v2, 0x7fffffff

    and-int/2addr p2, v2

    invoke-interface {p3, p2}, Lf0/d;->writeInt(I)Lf0/d;
    ...
    invoke-interface {p2, p3, v4, v5}, Lf0/s;->write(Lf0/c;J)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lf0/d;

    invoke-interface {v3, v0}, Lf0/d;->writeShort(I)Lf0/d;
    ...
    invoke-interface {v0, v3}, Lf0/d;->writeInt(I)Lf0/d;
