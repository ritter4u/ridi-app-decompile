...
.method public constructor <init>(Lf0/e;Z)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lf0/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILf0/t;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILf0/e;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;

    invoke-interface {p4}, Lf0/e;->readInt()I

    move-result p4

    .line 2
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;

    invoke-interface {v2}, Lf0/e;->readInt()I
    ...
    invoke-interface {p3, v1, v2}, Lf0/e;->f(J)Lokio/ByteString;
...
.method public static readMedium(Lf0/e;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p0}, Lf0/e;->readByte()B
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;

    invoke-interface {p2}, Lf0/e;->readInt()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {v0}, Lf0/e;->readInt()I
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;

    invoke-interface {v3}, Lf0/e;->readByte()B
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lf0/e;

    invoke-interface {v1}, Lf0/e;->readInt()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2}, Lf0/e;->readShort()S
    ...
    invoke-interface {v3}, Lf0/e;->readInt()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lf0/e;->d(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lf0/e;)I
    ...
    invoke-interface {p1}, Lf0/e;->readByte()B
    ...
    invoke-interface {p1, v0, v1}, Lf0/e;->skip(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v3, v4}, Lf0/e;->f(J)Lokio/ByteString;
