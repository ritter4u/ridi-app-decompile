...
.field public final emitter:Lz/b/w;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lz/b/w<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Lz/b/w;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lz/b/w;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->queue:Lz/b/n0/f/a;
...
.method public drainLoop()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lz/b/w;

    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->queue:Lz/b/n0/f/a;
    ...
    :cond_0
    :goto_0
    invoke-interface {v0}, Lz/b/w;->isDisposed()Z
    ...
    invoke-interface {v0, v1}, Lz/b/g;->onError(Ljava/lang/Throwable;)V
    ...
    .line 11
    invoke-interface {v0}, Lz/b/g;->onComplete()V
    ...
    .line 13
    :cond_5
    invoke-interface {v0, v6}, Lz/b/g;->onNext(Ljava/lang/Object;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 6
    :cond_2
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->queue:Lz/b/n0/f/a;
...
.method public serialize()Lz/b/w;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public setCancellable(Lz/b/m0/f;)V
    .locals 1

    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lz/b/w;

    invoke-interface {v0, p1}, Lz/b/w;->setCancellable(Lz/b/m0/f;)V

    return-void
.end method

.method public setDisposable(Lz/b/k0/b;)V
    .locals 1

    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lz/b/w;

    invoke-interface {v0, p1}, Lz/b/w;->setDisposable(Lz/b/k0/b;)V
