...
.field public final isEqual:Lz/b/m0/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lz/b/m0/d<",
            "-TT;-TT;>;"
...
# direct methods
.method public constructor <init>(Lz/b/g0;Lz/b/m0/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->downstream:Lz/b/g0;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->isEqual:Lz/b/m0/d;
...
.method public done()V
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->isEqual:Lz/b/m0/d;

    check-cast v2, Lz/b/n0/b/a$a;

    if-eqz v2, :cond_0

    .line 5
    invoke-static {v0, v1}, Lz/b/n0/b/a;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->downstream:Lz/b/g0;
    ...
    .line 10
    :cond_1
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->downstream:Lz/b/g0;
    ...
    invoke-interface {v2, v0}, Lz/b/g0;->onSuccess(Ljava/lang/Object;)V
...
.method public error(Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualObserver;Ljava/lang/Throwable;)V
    ...
    .line 5
    :goto_0
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->downstream:Lz/b/g0;

    invoke-interface {p1, p2}, Lz/b/g0;->onError(Ljava/lang/Throwable;)V
...
.method public subscribe(Lz/b/t;Lz/b/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p1}, Lz/b/t;->a(Lz/b/r;)V
