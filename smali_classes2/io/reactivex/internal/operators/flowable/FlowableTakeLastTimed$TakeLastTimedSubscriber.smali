...
# direct methods
.method public constructor <init>(Lg0/g/c;JJLjava/util/concurrent/TimeUnit;Lz/b/c0;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lg0/g/c;
    ...
    .line 7
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Lz/b/c0;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lz/b/n0/f/a;
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lg0/g/d;
    ...
    .line 5
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lz/b/n0/f/a;
...
.method public checkTerminated(ZLg0/g/c;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 2
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lz/b/n0/f/a;
    ...
    .line 8
    invoke-interface {p2, p3}, Lg0/g/c;->onError(Ljava/lang/Throwable;)V
...
.method public drain()V
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lg0/g/c;

    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lz/b/n0/f/a;
    ...
    .line 6
    invoke-virtual {v1}, Lz/b/n0/f/a;->isEmpty()Z

    move-result v5

    .line 7
    invoke-virtual {p0, v5, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLg0/g/c;Z)Z
    ...
    .line 9
    :goto_0
    invoke-virtual {v1}, Lz/b/n0/f/a;->peek()Ljava/lang/Object;
    ...
    .line 10
    :goto_1
    invoke-virtual {p0, v11, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLg0/g/c;Z)Z
    ...
    invoke-static {v5, v9, v10}, Lf/b0/a/j;->c(Ljava/util/concurrent/atomic/AtomicLong;J)J

    goto :goto_2

    .line 12
    :cond_5
    invoke-virtual {v1}, Lz/b/n0/f/a;->poll()Ljava/lang/Object;
    ...
    .line 14
    invoke-interface {v0, v11}, Lg0/g/c;->onNext(Ljava/lang/Object;)V
...
.method public onComplete()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Lz/b/c0;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lz/b/n0/f/a;

    invoke-virtual {p0, v0, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLz/b/n0/f/a;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Lz/b/c0;
    ...
    invoke-virtual {v0, v3, p1}, Lz/b/n0/f/a;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    .line 4
    invoke-virtual {p0, v1, v2, v0}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLz/b/n0/f/a;)V
...
.method public onSubscribe(Lg0/g/d;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lg0/g/d;
...
.method public trim(JLz/b/n0/f/a;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 3
    :goto_0
    invoke-virtual {p3}, Lz/b/n0/f/a;->isEmpty()Z
    ...
    .line 4
    invoke-virtual {p3}, Lz/b/n0/f/a;->peek()Ljava/lang/Object;
    ...
    .line 5
    invoke-virtual {p3}, Lz/b/n0/f/a;->c()I
    ...
    .line 6
    :cond_1
    invoke-virtual {p3}, Lz/b/n0/f/a;->poll()Ljava/lang/Object;
